...
Gases reported by vegetation type:

| Fire Category      | CO₂  | CH₄ | N₂O | CO       | NO~x~    |
|--------------------|------|-----|-----|----------|----------|
| Forest Fires       | ❌\* | ✅  | ✅  | Optional | Optional |
| Savanna Fires      | ❌\* | ✅  | ✅  | Optional | Optional |
| Organic Soil Fires | ✅   | ✅  | ❌  | Optional | Optional |

\*CO₂ excluded from forest/savanna fires (captured in carbon
stock changes or assumed balanced by regrowth)
...
## Chapter Summary and Next Steps {#sec-emissions-summary}
...
### Progression to Chapter 5 {#sec-emissions-to-chapter5}
