...
#### 02 Fuel Stratification {.unnumbered}

Classify burned pixels into Forest (Humid Tropical, Other[^index-1]), Savanna, and Organic Soil categories using MODIS land cover and auxiliary datasets.

#### 03 Fuel Consumption {.unnumbered}
...
#### 04 Emission Factors {.unnumbered}

Apply IPCC emission factors (Table 2.5) to compute CH₄ and N₂O emissions via Equation 2.27, account for forest CO₂ through carbon stock changes, convert to CO₂-equivalents, and format outputs for UNFCCC CRF reporting.

#### 05 Uncertainty & Reporting (Pending) {.unnumbered}
...
-   Emission Factors: IPCC defaults ~~vs. regional measurements from literature~~[^index-2]
...
[^index-2]: Note to self: 2025 wishlist
